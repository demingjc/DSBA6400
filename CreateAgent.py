...
# May want to turn this off when testing
...
if today.minute < 10:
    ...
    m = str(today.minute)
directory = "TrainData" + today.strftime('%Y%m%d_') + h + m + "_npy"
...
route_1_indices = [33,58,154,147,124,199,129,97,28]
route_1 = []
